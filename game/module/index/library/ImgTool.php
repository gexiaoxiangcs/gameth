...
class ImgTool {
    ...
    public function __construct($configs = array()){
        $default = array(
            'maxSize'    =>    4194304,
            'rootPath'   =>    realpath(dirname(__FILE__) . '/../../../../ThinkPHP3.2/Application/') . '/Home/Uploads/',
            'savePath'   =>    '',
...
//            $this->error($this->uploadhl->getError());
    ...
    public function saveGifOneFrame($picname, $dstname = false){
        ...
        $img = new \Index\GIF($this->configs['rootPath'] . $picname);
